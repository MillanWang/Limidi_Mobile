...
import { setColumnCount, setRowCount, unlockAllGridElements, restoreCurrentPresetToDefault } from "../../../redux/slices/GridPresetsSlice";
    ...
    return (
        <View style={styles.container}>
            ...
            <Slider
                ...
                value={rowState}
                onValueChange={(value) => {
                    dispatch(setRowCount(value));
                }}
            />
            <Button
                title="Unlock All Grid Elements"
                onPress={() => {
                    dispatch(unlockAllGridElements(null));
                }}
            />
            <Button
